...
class OSS {
	 ...
	 */    
  	...
  	public function __construct($isInternal = false)
  	{
  		...
  		$this->AccessKeyId = env('ALIYUN_OSS_ACCESS_ID');

  		$this->AccessKeySecret = env('ALIYUN_OSS_ACCESS_KEY');

  		$this->bucketName  = env('ALIYUN_OSS_BUCKET');
  	...
  	{
  		$bucketName = env('ALIYUN_OSS_BUCKET');
